    ...
    <main className="main-content container" style={{ padding: '40px 20px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{ background: 'var(--color-navy)', borderRadius: '16px', overflow: 'hidden', color: 'white', position: 'relative', boxShadow: '0 10px 30px rgba(0,0,0,0.1)' }}>
        ...
        <div style={{ width: '100%', height: '400px', background: '#e2e8f0' }}>
          <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1m3!1d1981.6508931139434!2d80.20816999999999!3d6.046522300000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae173a11c828d11%3A0xe5a3c945b0bb6224!2sRichmond%20College!5e0!3m2!1sen!2slk!4v1717424912345!5m2!1sen!2slk" 
            width="100%" 
            height="100%" 
            style={{ border: 0 }} 
